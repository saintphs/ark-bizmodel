<%--
  Class Name : Knowledge.jsp
  Description : 지식 맵(Knowledge)
  Modification Information
 
      수정일         수정자                   수정내용
    -------    --------    ---------------------------
     2017.01.03   PHS       경량환경 버전 생성
...
<meta charset="UTF-8">
<script src="<c:url value='/js/go-debug.js' />"></script>
...
<div id="sample">
  <div id="myDiagramDiv" style="border: solid 1px blue; width:100%; height:500px; min-width: 20px"></div>
</div>
